const dadosc = require('./clientes/dados.json')
const dadosf = require('./fornecedores/dados.json')
const dadosm = require('./medicamentos/dados.json')
const dadosv = require('./vendas/dados.json')
...
function salvarDadosc() {
    fs.writeFileSync(__dirname + '/clientes/dados.json', JSON.stringify(dadosc, null, 2))
}
...
function salvarDadosf() {
    fs.writeFileSync(__dirname + '/fornecedores/dados.json', JSON.stringify(dadosf, null, 2))
}
...
function salvarDadosm() {
    fs.writeFileSync(__dirname + '/medicamentos/dados.json', JSON.stringify(dadosm, null, 2))
}
...
function salvarDadosv() {
    fs.writeFileSync(__dirname + '/vendas/dados.json', JSON.stringify(dadosv, null, 2))
}
